      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                To preserve and promote the cultural heritage of Hubballi-Dharwad by providing a comprehensive platform
                for discovering ancient temples, traditional eateries, and local events that define our community.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Built by locals, for locals. Our platform celebrates the stories, traditions, and experiences that make
                Hubballi-Dharwad unique, fostering connections within our community.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="bg-muted rounded-lg p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Help us grow this platform by sharing your favorite places, events, and stories. Together, we can create the
            most comprehensive guide to Hubballi-Dharwad.
          </p>
